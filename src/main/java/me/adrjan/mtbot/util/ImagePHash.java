...
public class ImagePHash {
    ...
    private String getHash(BufferedImage bufferedImage) throws Exception {
     ...
     * @throws Exception
     */
    public int distance(BufferedImage srcFile, BufferedImage canFile) throws Exception {
        String imageSrcFile = this.getHash(srcFile);
        String imageCanFile = this.getHash(canFile);
